                            ...
                            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                <div class="relative text-lg bg-transparent text-gray-800">
                                    <div class="flex items-center border-b border-b-2 border-teal-500 py-2">
                                        <input class="bg-transparent h-full w-full border-none mr-0 px-2 leading-tight focus:outline-none" type="text" placeholder="Enter an address, city or postal code">
