...
{{--            bg-gray-100--}}
            <div class="welcome relative flex items-top justify-center bg-gradient-to-r from-indigo-50 to-indigo-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <!-- Container containing 2 cards -->
                    <div class="flex sm:flex-1 overflow-hidden">
                        <!--Card 1-->
                        <div class="p-10 flex-none">
                            <div class="flex-1 max-w-md rounded-lg bg-white justify-center overflow-hidden shadow-lg">
                                <div class="flex justify-center py-2">
                                    <img src="{{ url('images/buy.jpg') }}" alt="Buy house" width="192">
                                </div>
                                <div class="px-6 py-4">
